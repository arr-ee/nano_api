NANO("api.search.sort", function(NANO){
  NANO.search.customize("collection", "tickets", function(proto){
    ...
    proto.sorting_methods = {
      "price": function(ticket){
        if(!!ticket.current_info){
          this.price = function(ticket){
            return ticket.current_info().price;
          };
        }else{
          this.price = function(ticket){
      ...
      "airline": function(ticket){
        ...
        return NANO.api.airlines.get(airline).name;
      },
