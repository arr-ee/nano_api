NANO.plugin(function (NANO) {
  var search = NANO.search = {
    ...
    new_search: function(search_data){
      ...
      _.each(this._params_list, function(param_name){
        request_data[param_name] = search_data.data[param_name];
      });
      var ajax_params = {
  ...
  search.collection("airlines", Data);
  search.collection("airports", Data);
  ...
  search.collection("gates_info", Gates);
  ...
  Ticket.prototype = {
    ...
    main_airline: function(){
      var direct_airline = this.ticket.direct_flights.airline();
      var return_airline = this.ticket.return_flights ? this.ticket.return_flights.airline() : {};
