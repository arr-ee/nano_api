...
describe NanoApi::MinimalPricesController do
  describe 'GET week' do
    it 'should forward json, received from api minimal_prices action' do
      NanoApi::Client.should_receive(:week_minimal_prices).with('1233', '2011-11-12', nil).and_return('{test: 1}')
  ...
  describe 'GET month' do
    it 'should forward json, received from api minimal_prices action' do
      NanoApi::Client.should_receive(:month_minimal_prices).with('1233', '2011-11-01').and_return('{test: 2}')
