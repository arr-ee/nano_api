...
describe NanoApi::PlacesController do
  describe 'GET index' do
    it 'should forward place json received from api call' do
      NanoApi::Client.any_instance.should_receive(:auto_complete_place).with('term').and_return('[place1, place2]')
    ...
    it 'should handle api errors' do
      NanoApi::Client.any_instance.should_receive(:auto_complete_place)
